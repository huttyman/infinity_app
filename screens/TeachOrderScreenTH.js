...
const TeachOrderScreenTH = props => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: "space-around", flexDirection: "row",padding:5 }}>
                <TouchableOpacity  onPress={()=>props.navigation.navigate({ routeName: 'TurnOrderTH' })}>
                    <Text style={{textDecorationLine:"underline"}}>Turn Order</Text>
                </TouchableOpacity>
                <TouchableOpacity  onPress={()=>props.navigation.navigate({ routeName: 'ActionOrderTH' })}>
                    <Text style={{textDecorationLine:"underline"}}>Attack order</Text>
                </TouchableOpacity>
            </View>
            <View>
                <View style={{ width: '100%', backgroundColor: 'white',paddingTop:5 }}>
                    <Text style={{ width: '100%', textAlign: "center", padding: 5, backgroundColor: 'white' }}><Text style={{ color: "red" }}>1 Order</Text> = ทำได้2อย่าง เลือกอันไหนก่อนก็ได้</Text>
                </View>
                <View style={styles.cardContainer}>
                    <TouchableOpacity onPress={() => { setToggleFirstCard(!toggleFirstCard) }}>
                        ...
                        <View style={[styles.card, { backgroundColor: Colors.shortMovement }]}>
                            <Text style={[styles.cardText, { paddingTop: 20 }]}>เดิน/นิ่ง/
            ค้นหา</Text>
                    ...
                    <TouchableOpacity onPress={() => { setToggleSecondCard(!toggleSecondCard) }}>
                        <View style={styles.card}>
                            <View style={[styles.bottomTopBox, { backgroundColor: Colors.shortMovement }]}>
                                ...
                                <Text style={[styles.cardText, { paddingTop: 3 }]}>เดิน/นิ่ง/
                                ค้นหา</Text>
                                <Text style={[styles.cardText, { fontWeight: "bold" }]}>Short Movement</Text>
                            </View>
                            <View style={styles.middleBox}>
                                <Text style={styles.cardText}>หรือ</Text>
                            </View>
                            <View style={[styles.bottomTopBox, { backgroundColor: Colors.shortSkill }]}>
                                <Text style={[styles.cardText, { paddingTop: 12 }]}>โจมตี/Hack/
                                                        รักษา/etc.</Text>
...
export default TeachOrderScreenTH;